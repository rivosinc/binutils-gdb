...
#define MATCH_VANDNVI 0x4003057
...
#define MATCH_VANDNVV 0x4000057
#define MASK_VANDNVV 0xfc00707f
#define MATCH_VANDNVX 0x4004057
...
/* Zvk* instructions. */
/* Zvkb instructions. */
DECLARE_INSN(vandn_vv, MATCH_VANDNVV, MASK_VANDNVV);
DECLARE_INSN(vandn_vx, MATCH_VANDNVX, MASK_VANDNVX);
DECLARE_INSN(vandn_vi, MATCH_VANDNVI, MASK_VANDNVI);
DECLARE_INSN(vclmul_vv, MATCH_VCLMULVV, MASK_VCLMULVV);
DECLARE_INSN(vclmul_vx, MATCH_VCLMULVX, MASK_VCLMULVX);
DECLARE_INSN(vclmulh_vv, MATCH_VCLMULHVV, MASK_VCLMULHVV);
DECLARE_INSN(vclmulh_vx, MATCH_VCLMULHVX, MASK_VCLMULHVX);
DECLARE_INSN(vrol_vv, MATCH_VROLVV, MASK_VROLVV);
DECLARE_INSN(vrol_vx, MATCH_VROLVX, MASK_VROLVX);
DECLARE_INSN(vror_vv, MATCH_VRORVV, MASK_VRORVV);
DECLARE_INSN(vror_vx, MATCH_VRORVX, MASK_VRORVX);
DECLARE_INSN(vror_vi, MATCH_VRORVI, MASK_VRORVI);
DECLARE_INSN(vbrev8_v, MATCH_VBREV8V, MASK_VBREV8V);
DECLARE_INSN(vrev8_v, MATCH_VREV8V, MASK_VREV8V);
/* Zvkg instructions. */
DECLARE_INSN(vghmac_vv, MATCH_VGHMACVV, MASK_VGHMACVV);
/* Zvknh[ab] instructions. */
DECLARE_INSN(vsha2ch_vv, MATCH_VSHA2CHVV, MASK_VSHA2CHVV)
DECLARE_INSN(vsha2cl_vv, MATCH_VSHA2CLVV, MASK_VSHA2CLVV)
DECLARE_INSN(vsha2ms_vv, MATCH_VSHA2MSVV, MASK_VSHA2MSVV)
/* Zvkns instructions. */
DECLARE_INSN(vaesdf_vs, MATCH_VAESDFVS, MASK_VAESDFVS)
DECLARE_INSN(vaesdf_vv, MATCH_VAESDFVV, MASK_VAESDFVV)
DECLARE_INSN(vaesdm_vs, MATCH_VAESDMVS, MASK_VAESDMVS)
DECLARE_INSN(vaesdm_vv, MATCH_VAESDMVV, MASK_VAESDMVV)
DECLARE_INSN(vaesef_vs, MATCH_VAESEFVS, MASK_VAESEFVS)
DECLARE_INSN(vaesef_vv, MATCH_VAESEFVV, MASK_VAESEFVV)
DECLARE_INSN(vaesem_vs, MATCH_VAESEMVS, MASK_VAESEMVS)
DECLARE_INSN(vaesem_vv, MATCH_VAESEMVV, MASK_VAESEMVV)
DECLARE_INSN(vaeskf1_vi, MATCH_VAESKF1VI, MASK_VAESKF1VI)
DECLARE_INSN(vaeskf2_vi, MATCH_VAESKF2VI, MASK_VAESKF2VI)
DECLARE_INSN(vaesz_vs, MATCH_VAESZVS, MASK_VAESZVS)
/* Zvksed instructions. */
DECLARE_INSN(vsm4k_vi, MATCH_VSM4KVI, MASK_VSM4KVI);
DECLARE_INSN(vsm4r_vs, MATCH_VSM4RVS, MASK_VSM4RVS);
DECLARE_INSN(vsm4r_vv, MATCH_VSM4RVV, MASK_VSM4RVV);
/* Zvksh instructions. */
DECLARE_INSN(vsm3c_vi, MATCH_VSM3CVI, MASK_VSM3CVI);
DECLARE_INSN(vsm3me_vv, MATCH_VSM3MEVV, MASK_VSM3MEVV);
/* Vendor-specific (T-Head) XTheadBa instructions.  */
